...
from dashboard.cmproducts.app import application as cmapp
...
class DashboardApplication(CoreDashboardApplication):
    ...
    #cmproduct_app = get_class('dashboard.cmproduct.app', 'cmapp')
    ...
    def get_urls(self):
        urls = [
            ...
            url(r'^catalogo/', include(self.catalogue_app.urls)),
            url(r'^cmproduct/', include(cmapp.urls)),
